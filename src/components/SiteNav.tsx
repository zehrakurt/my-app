...
function IconInstagram({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      />
      <path
        d="M17.374 3H6.626C4.624 3 3 4.624 3 6.626v10.748C3 19.376 4.624 21 6.626 21h10.748c2.002 0 3.626-1.624 3.626-3.626V6.626C21 4.624 19.376 3 17.374 3Z"
        stroke="currentColor"
        strokeWidth={1.5}
        strokeMiterlimit={10}
      />
          ...
          >
            ...
            <div className="border-t border-white/[0.06] p-6 space-y-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-sm font-medium text-[#f5f2ec] hover:text-[#ddbd53]"
              >
